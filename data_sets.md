...
3. [rice (7 features)](https://archive.ics.uci.edu/dataset/545/rice+cammeo+and+osmancik)
4. [Raisin binary classification (7 features)](https://www.kaggle.com/datasets/nimapourmoradi/raisin-binary-classification)
...
11. [Dry bean - isn't binary but classes can be merged (17 features)](https://www.kaggle.com/datasets/nimapourmoradi/dry-bean-dataset-classification)